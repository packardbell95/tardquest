...
(function(){
    ...
    const STATIC_MANIFEST = [
        ...
        "./assets/fp-anim/fp-pigeonMurder.webm",
        ...
        "./assets/interface/ui/battle-icons/arrow-medium.png",
        "./assets/interface/ui/battle-icons/arrow-square.png",
        "./assets/interface/ui/battle-icons/arrow.png",
        "./assets/interface/ui/battle-icons/attack.png",
        "./assets/interface/ui/battle-icons/persuade.png",
        "./assets/interface/ui/battle-icons/run.png",
        "./assets/interface/ui/battle-icons/use-item.png",
        "./assets/interface/ui/boulding-ball-strike.gif",
        "./assets/interface/ui/confirm.png",
        "./assets/interface/ui/cursor.png",
        "./assets/interface/ui/down.png",
        "./assets/interface/ui/edit.png",
        "./assets/interface/ui/fly.gif",
        ...
        "./assets/interface/ui/tardpad-connected.png",
        "./assets/interface/ui/tardpad-disconnected.png",
        "./assets/interface/ui/tardpad.png",
        "./assets/interface/ui/tile1.gif",
        "./assets/interface/ui/tile1.png",
        "./assets/interface/ui/tile2.png",
        ...
        "./assets/portraits/badassFlamingSkeleton.png",
        "./assets/portraits/fridgeOfForgottenLeftovers.png",
        "./assets/portraits/keeperOfTheToiletBowl.png",
        "./assets/portraits/krampusElf.png",
        "./assets/portraits/lughead.png",
        "./assets/portraits/mimic.png",
        "./assets/portraits/mysteriousScooter.png",
        "./assets/portraits/overlays/x.png",
        "./assets/portraits/pissedOffPoultry.png",
        "./assets/portraits/placeholder.png",
        "./assets/portraits/player.png",
        "./assets/portraits/snailSentinel.png",
        "./assets/portraits/stupidDog.png",
        "./assets/portraits/vampire.png",
        "./assets/portraits/wangRat.png",
        "./assets/title/background.gif",
        "./assets/viewport-overlays/atlatl-spear.txt",
        "./assets/viewport-overlays/atlatl-spear.webm",
        "./assets/viewport-overlays/battle-end-curtain-drop.txt",
        "./assets/viewport-overlays/battle-end-curtain-drop.webm",
        "./assets/viewport-overlays/battle-start-curtain-drop.txt",
        "./assets/viewport-overlays/battle-start-curtain-drop.webm",
        "./assets/viewport-overlays/bludgeoning-mace.txt",
        "./assets/viewport-overlays/bludgeoning-mace.webm",
        "./assets/viewport-overlays/crt.txt",
        "./assets/viewport-overlays/crt.webm",
        "./assets/viewport-overlays/dance-club.txt",
        "./assets/viewport-overlays/dance-club.webm",
        "./assets/viewport-overlays/explosion.txt",
        "./assets/viewport-overlays/explosion.webm",
        "./assets/viewport-overlays/fingernail.txt",
        "./assets/viewport-overlays/fingernail.webm",
        "./assets/viewport-overlays/golden-wang.txt",
        "./assets/viewport-overlays/golden-wang.webm",
        "./assets/viewport-overlays/heal.txt",
        "./assets/viewport-overlays/heal.webm",
        "./assets/viewport-overlays/level-up-curtain-drop.txt",
        "./assets/viewport-overlays/level-up-curtain-drop.webm",
        "./assets/viewport-overlays/lode-gun.txt",
        "./assets/viewport-overlays/lode-gun.webm",
        "./assets/viewport-overlays/magic-pencil.txt",
        "./assets/viewport-overlays/magic-pencil.webm",
        "./assets/viewport-overlays/nunchucks.txt",
        "./assets/viewport-overlays/nunchucks.webm",
        "./assets/viewport-overlays/persuasion.txt",
        "./assets/viewport-overlays/persuasion.webm",
        "./assets/viewport-overlays/pointy-stick.txt",
        "./assets/viewport-overlays/pointy-stick.webm",
        "./assets/viewport-overlays/pov-punched.txt",
        "./assets/viewport-overlays/pov-punched.webm",
        "./assets/viewport-overlays/rat-chomp.txt",
        "./assets/viewport-overlays/rat-chomp.webm",
        "./assets/viewport-overlays/slash.txt",
        "./assets/viewport-overlays/slash.webm",
        "./assets/viewport-overlays/smokescreen.txt",
        "./assets/viewport-overlays/smokescreen.webm",
        "./assets/viewport-overlays/wiffle-ball-bat.txt",
        "./assets/viewport-overlays/wiffle-ball-bat.webm",
        "./audio/ambient/chain1.ogg",
        "./audio/ambient/howl1.ogg",
        "./audio/ambient/rat1.ogg",
        "./audio/ambient/run1.ogg",
        "./audio/music/battle1.mp3",
        "./audio/music/battle2.mp3",
        "./audio/music/battle3.mp3",
        "./audio/music/battle4.mp3",
        "./audio/music/battle5.mp3",
        "./audio/music/battle6.mp3",
        "./audio/music/erok.mp3",
        "./audio/music/explore1.mp3",
        "./audio/music/explore2.mp3",
        "./audio/music/explore3.mp3",
        "./audio/music/explore4.mp3",
        "./audio/music/explore5.mp3",
        "./audio/music/gamblers-theme.mp3",
        "./audio/music/lurking.ogg",
        "./audio/music/merchant.mp3",
        "./audio/music/title.mp3",
        "./audio/music/vampire-vengeful-fruit-intro.mp3",
        "./audio/music/vampire-vengeful-fruit-main-loop.mp3",
        "./audio/sfx/alert.ogg",
        "./audio/sfx/ash.mp3",
        "./audio/sfx/attack.mp3",
        "./audio/sfx/attacked.mp3",
        "./audio/sfx/attackedParty.mp3",
        "./audio/sfx/bat-wings-dry.ogg",
        "./audio/sfx/bat-wings-wet.ogg",
        "./audio/sfx/battleEnd.mp3",
        "./audio/sfx/battleStart.mp3",
        "./audio/sfx/boulder-near.ogg",
        "./audio/sfx/boulding-ball-strike.ogg",
        "./audio/sfx/breathe1.mp3",
        "./audio/sfx/breathe2.mp3",
        "./audio/sfx/erok-near.ogg",
        "./audio/sfx/explosion.mp3",
        "./audio/sfx/floorBreakScreamDie.mp3",
        "./audio/sfx/floorCrackSlight.mp3",
        "./audio/sfx/fly.ogg",
        "./audio/sfx/footsteps-descending.mp3",
        "./audio/sfx/footsteps.mp3",
        "./audio/sfx/gamble.mp3",
        "./audio/sfx/healingTile.mp3",
        "./audio/sfx/healParty.mp3",
        "./audio/sfx/inventoryOpen.mp3",
        "./audio/sfx/kaching.mp3",
        "./audio/sfx/lean.mp3",
        "./audio/sfx/merchant-near.ogg",
        "./audio/sfx/persuade.mp3",
        "./audio/sfx/pitDrop.ogg",
        "./audio/sfx/raisins.mp3",
        "./audio/sfx/ran.ogg",
        "./audio/sfx/run.mp3",
        "./audio/sfx/runFailed.ogg",
        "./audio/sfx/scream.mp3",
        "./audio/sfx/torch.mp3",
        "./audio/sfx/tromBONE.mp3",
        "./audio/sfx/turn.mp3",
        "./audio/sfx/uiCancel.mp3",
        "./audio/sfx/uiOption.mp3",
        "./audio/sfx/uiSelect.mp3",
    ];
