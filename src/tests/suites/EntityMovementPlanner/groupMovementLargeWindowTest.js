// Behavioral tests for the Entity Movement Planner using a large plan window
function EntityMovementPlanner_groupMovementLargeWindowTest()
{
    const originalWindowSize = EntityMovementPlanner.windowSize;
    EntityMovementPlanner.windowSize = 30;
    ...
    test(
        "Autonomous Entities Navigating Corridors, Large Plan Window Size",
        () => {
